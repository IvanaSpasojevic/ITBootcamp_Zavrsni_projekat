...
public class TestTopMeni {
	...
	public void shiftplanning() {
		Assert.assertEquals(TopMeni.topMeni(driver, TopMeniConstants.SHIFTPLANNING_ID), TopMeniConstants.SHIFTPLANNING_URL + Helper.getDateShiftPlanning() + "/");
	}
	...
	public void aviability() {
		Assert.assertEquals(TopMeni.topMeni(driver, TopMeniConstants.AVAILABILITY_ID), TopMeniConstants.AVAILABILITY_URL + Helper.getDateAvailability() + "/1");
	}
